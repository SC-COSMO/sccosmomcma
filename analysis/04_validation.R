...
load(paste0("data/MCMA_calibration_data_",n_time_stamp,".RData"))


# Load calibrated parameters ----------------------------------------------

files <- list.files(paste0("./output/"), 
                    pattern = paste0("03_map_output_IMIS_",abbrev_state,"_",n_time_stamp))
...
save(l_fit_imis,
     ...
     m_cfr,
     l_out_post_summ,
     file = paste0("output/04_validation_IMIS_",abbrev_state,"_",n_time_stamp,".RData"))
...
# Save plot
ggsave(filename = paste0("figs/04_validation_targets_vs_model_IMIS_",abbrev_state,"_", n_time_stamp,".pdf"),
